package com.jew.coree.treader.view;
...
import com.jew.coree.treader.view.animation.AnimationProvider;
import com.jew.coree.treader.view.animation.CoverAnimation;
import com.jew.coree.treader.view.animation.NoneAnimation;
import com.jew.coree.treader.view.animation.SimulationAnimation;
import com.jew.coree.treader.view.animation.SlideAnimation;
...
//        LogUtils.e("onDraw" + "isNext:" + isNext + "          isRuning:" + isRuning);
        if (isRuning) {
