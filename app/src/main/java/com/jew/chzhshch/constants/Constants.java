...
public class Constants {
    public static final String APPID = "1101090090";
    public static final String BannerPosID = "5060232112658518";
    public static final String InterteristalPosID = "9030336162457610";
    public static final String SplashPosID = "3030427903785292";
